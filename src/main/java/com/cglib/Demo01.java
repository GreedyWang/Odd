...
//    }
    ...
    public static void test04() throws Exception{
        ClassPool pool  = ClassPool.getDefault();
        CtClass cc = pool.get("com.cglib.Student");

        //属性
        CtField cf = new CtField(CtClass.intType,"age2",cc);
        cf.setModifiers(Modifier.PRIVATE);
        cc.addField(cf);
        //增加响应的get set方法
        cc.addMethod(CtNewMethod.getter("getAge2",cf));
        cc.addMethod(CtNewMethod.setter("setAge2",cf));

        //访问属性
        Class clazz = cc.toClass();
        Object obj = clazz.newInstance();
        Field field = clazz.getDeclaredField("age2");
        System.out.println(field);
        Method m = clazz.getDeclaredMethod("setAge2", int.class);
        m.invoke(obj, 16);
        Method m2 = clazz.getDeclaredMethod("getAge2", null);
